...
public privileged aspect AspectJMLRac_Facade {
  ...
  after (final facade.Facade object$rac, final java.lang.String ID) throwing (Throwable rac$e) :
     execution(models.mercadoria.IMercadoria facade.Facade.buscarMercadoria(java.lang.String)) && this(object$rac) && args(ID) {
           JMLChecker.rethrowJMLAssertionError(rac$e, "facade.Facade.buscarMercadoria(java.lang.String ID)");
           boolean rac$b = true;
           String rac$ErrorMsg = "";
           ...
           JMLChecker.checkExceptionalPostcondition(rac$b, xPostErrorMsg+"\n\t"+rac$ErrorMsg+rac$e, -1, false, "facade.Facade.buscarMercadoria(java.lang.String ID)");
  	 }
  ...
  /** Generated by JML to check the precondition of
   * method buscarMercadoria. */
  before (final facade.Facade object$rac, final java.lang.String ID) :
     execution(models.mercadoria.IMercadoria facade.Facade.buscarMercadoria(java.lang.String)) && 
     this(object$rac) && args(ID) {
       boolean rac$b = (ID != null);
       boolean canThrow = false;
       String preErrorMsg = "by method facade.Facade.buscarMercadoria regarding code at \nFile \"facade.Facade.java\", line 87 (facade.Facade.java:87)"+", when \n"+"\t\'ID\' is "+ID;
       String evalErrorMsg = "Invalid expression in \"facade.Facade.java\"\nCaused by: ";
       JMLChecker.checkPrecondition(rac$b, canThrow, preErrorMsg, evalErrorMsg, -1, false, "facade.Facade.buscarMercadoria(java.lang.String ID)");
